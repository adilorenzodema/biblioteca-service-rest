...
public class infoPrestito {
    ...
    public infoPrestito(Long idPrestito, Long idUtente, Long idLibro, String nomeCognome,Timestamp dataInizio, Timestamp dataFine, Timestamp dataRestituzione, String titoloLibro) {
